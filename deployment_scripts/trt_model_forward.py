...
def setup_tensorrt_engines(policy, trt_engine_path):
    ...
    policy.model.backbone.num_patches = (
        policy.model.backbone.model.vision_model.vision_model.embeddings.num_patches
    )
    if hasattr(policy.model.backbone.model, "vision_model"):
        del policy.model.backbone.model.vision_model
    if hasattr(policy.model.backbone.model, "language_model"):
        del policy.model.backbone.model.language_model
